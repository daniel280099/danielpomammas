		...
		public function Operadores($nota1,$nota2,$operaciones){
			switch ($operaciones){
			    case 'Suma':
			        ...
			        echo '<p>la suma entre estsos numeros : '.$nota1 ." + ". $nota2 ." = ". $dataSuma.'</p>';
			        break;
			    case 'Resta':
			    	$dataSuma = $nota1 - $nota2;
			        echo '<p>la suma entre estsos numeros : '.$nota1 ." - ". $nota2 ." = ". $dataSuma.'</p>';
			    ...
			    case 'Division':
			        ...
			        .'<div class="col-4"><input class="form-control" placeholder="'.$nota1.'"></div>'." / "
			        .'<div class="col-4"><input class="form-control" placeholder="'.$nota2.'"></div>'." = "
			        . '<div class="col-3"><input class="form-control" placeholder="'.$dataSuma.'"></div>'.'</p>';
			        break;
			    case 'Multiplicacion':
			        $dataSuma = $nota1 * $nota2;
			        echo '<p>la Division entre estos numeros : '.$nota1 ." * ". $nota2 ." = ". $dataSuma.'</p>';
			        break;
